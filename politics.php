...
<head>
    ...
    <meta name="description" content="Подтвердите свою квалификацию для заказчика оценив свой опыт и деловую репутацию по ГОСТу и получите конкурентное преимущество. В процессе сертификации проверяются все доступные сведения, что гарантированно подтверждает вашу состоятельность перед контрагентами.">
    ...
    <title>Центр сертификации деловой репутации в строительной отрасли</title>
    ...
    <header class="header">
        <div class="content-wrap">
            <nav class="nav nav_top">
                ...
                <a href="tel:+79052773333" class="phone">+7 (905) 277-33-33</a>
            </nav>
        </div>
    </header>
        ...
        <div class="content-wrap">
            <div class="part">
                ...
                <p>Настоящая Политика конфиденциальности персональных данных (далее – Политика конфиденциальности) действует в
                    отношении всей информации, которую сайт <strong>Центр сертификации деловой репутации в строительной отрасли</strong>, (далее – Центр сертификации) расположенный на
                    доменном имени <strong>comnpo.com</strong> (а также его субдоменах), может получить о Пользователе во время использования
                    сайта comnpo.com (а также его субдоменов), его программ и его продуктов.</p>
            </div>
            ...
            <div class="part">
                ...
                <p>1.1.1. «<strong>Администрация сайта</strong>» (далее – Администрация) – уполномоченные сотрудники на управление сайтом <strong>Центр сертификации деловой репутации в строительной отрасли</strong>, которые организуют и (или) осуществляют обработку персональных данных, а также определяет цели обработки персональных
                ...
                <p>1.1.5. «Сайт <strong> Центр сертификации деловой репутации в строительной отрасли</strong>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному
                    адресу (URL): <strong>comnpo.com</strong>, а также его субдоменах.</p>

                <p>1.1.6. «Субдомены» - это страницы или совокупность страниц, расположенные на доменах третьего уровня,
                    принадлежащие сайту Центр сертификации деловой репутации в строительной отрасли, а также другие временные страницы, внизу который указана контактная
                    информация Администрации</p>

                <p>1.1.5. «Пользователь сайта <strong>Центр сертификации деловой репутации в строительной отрасли</strong> » (далее Пользователь) – лицо, имеющее доступ
                    к сайту <strong>Центр сертификации деловой репутации в строительной отрасли</strong>, посредством сети Интернет
                    и использующее информацию, материалы и продукты сайта <strong>Центр сертификации деловой репутации в строительной отрасли</strong>.</p>
                ...
                <p>1.1.8. «IP-адрес» — уникальный сетевой адрес узла в компьютерной сети, через который Пользователь получает доступ на
                    Центр сертификации.</p>
            </div>

            <div class="part">
                <h2>2. Общие положения</h2>
                <p>2.1. Использование сайта Центр сертификации деловой репутации в строительной отрасли Пользователем означает согласие с настоящей Политикой
                ...
                <p>2.2. В случае несогласия с условиями Политики конфиденциальности Пользователь должен прекратить использование
                    сайта Центр сертификации деловой репутации в строительной отрасли .</p>

                <p>2.3. Настоящая Политика конфиденциальности применяется к сайту Центр сертификации деловой репутации в строительной отрасли.
                    Центр сертификации не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь
                    может перейти по ссылкам, доступным на сайте Центр сертификации деловой репутации в строительной отрасли.</p>
            ...
            <div class="part">
                ...
                <p>3.1. Настоящая Политика конфиденциальности устанавливает обязательства Администрации по неразглашению и обеспечению
                    ...
                    регистрации на сайте Центр сертификации деловой репутации в строительной отрасли или при подписке на информационную e-mail рассылку.</p>

                <p>3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются
                    Пользователем путём заполнения форм на сайте Центр сертификации деловой репутации в строительной отрасли и включают в себя следующую информацию:<br>
                ...
                <p>3.3. Центр сертификации защищает Данные, которые автоматически передаются при посещении страниц:<br>
                    - IP адрес;<br>
                ...
                <p>3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта <!--?php echo Центр сертификации деловой репутации в строительной отрасли ?-->, требующим
                    авторизации.</p>

                <p>3.3.2. Центр сертификации осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация
            ...
            <div class="part">
                ...
                <p>4.1. Персональные данные Пользователя Администрация может использовать в целях:<br>
                    4.1.1. Идентификации Пользователя, зарегистрированного на сайте Центр сертификации деловой репутации в строительной отрасли для его дальнейшей авторизации.<br>

                    4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта Центр сертификации деловой репутации в строительной отрасли.<br>

                    4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся использования
                    сайта Центр сертификации деловой репутации в строительной отрасли, обработки запросов и заявок от Пользователя.<br>

                    4.1.4. Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.<br>

                    4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br>

                    4.1.6. Создания учетной записи для использования частей сайта Центр сертификации деловой репутации в строительной отрасли, если Пользователь дал согласие на
                    ...
                    сайта Центр сертификации деловой репутации в строительной отрасли.<br>
            ...
            <div class="part">
                ...
                <p>6.1.1. Принимать свободное решение о предоставлении своих персональных данных, необходимых для использования
                    сайта Центр сертификации деловой репутации в строительной отрасли, и давать согласие на их обработку.</p>
            ...
            <div class="part">
                ...
                <p>7.4. Пользователь признает, что ответственность за любую информацию (в том числе, но не ограничиваясь: файлы с данными,
                    тексты и т. д.), к которой он может иметь доступ как к части сайта Центр сертификации деловой репутации в строительной отрасли, несет лицо, предоставившее
                    такую информацию.</p>

                <p>7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта Центр сертификации деловой репутации в строительной отрасли, может
                    являться объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям,
                    партнерам или рекламодателям, которые размещают такую информацию на сайте Центр сертификации деловой репутации в строительной отрасли. <br>
                ...
                <p>7.6. В отношение текстовых материалов (статей, публикаций, находящихся в свободном публичном доступе на
                    сайте Центр сертификации деловой репутации в строительной отрасли) допускается их распространение при условии, что будет дана ссылка
                    на Центр сертификации.</p>
                ...
                <p>7.7. Администрация не несет ответственности перед Пользователем за любой убыток или ущерб, понесенный Пользователем
                    ...
                    содержащихся на сайте Центр сертификации деловой репутации в строительной отрасли или передаваемых через него.</p>
                ...
                <p>7.9. Администрация не несет ответственность за какую-либо информацию, размещенную пользователем на
                    сайте Центр сертификации деловой репутации в строительной отрасли, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого
            ...
            <div class="part">
                ...
                <p>9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте Центр сертификации деловой репутации в строительной отрасли, если
                ...
                <p>9.3. Все предложения или вопросы касательно настоящей Политики конфиденциальности следует сообщать по
                    адресу: info@comnpo.com</p>

                <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу https://comnpo.com/politics.php</p>
                <br><br>

                <p>Обновлено: 08 Июня 2023 года</p>
                <p>г. Москва, Орган по сертификации деловой репутации в строительной отрасли РФ ОГРН 1097847084510</p>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="content-wrap">
            ...
            <div class="footer__right">
                <span class="caption">ИНН: 7806408197</span>
                <span class="caption">ОГРН: 1097847084510</span>
            </div>
        </div>
    </footer>
</body>
